#[doc = "Register `UARTRFR` reader"]
pub type R = crate::R<UartrfrSpec>;
...
#[doc = "Flag register\n\nYou can [`read`](crate::Reg::read) this register and get [`uartrfr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UartrfrSpec;
impl crate::RegisterSpec for UartrfrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`uartrfr::R`](R) reader structure"]
impl crate::Readable for UartrfrSpec {}
#[doc = "`reset()` method sets UARTRFR to value 0"]
impl crate::Resettable for UartrfrSpec {
