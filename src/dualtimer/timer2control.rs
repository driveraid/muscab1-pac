#[doc = "Register `TIMER2CONTROL` reader"]
pub type R = crate::R<Timer2controlSpec>;
#[doc = "Register `TIMER2CONTROL` writer"]
pub type W = crate::W<Timer2controlSpec>;
...
impl W {
    #[doc = "Bit 0 - Selects one-shot or wrapping counter mode."]
    #[inline(always)]
    pub fn one_shot_count(&mut self) -> OneShotCountW<Timer2controlSpec> {
        OneShotCountW::new(self, 0)
    }
    #[doc = "Bit 1 - Selects 16-bit or 32- bit counter operation."]
    #[inline(always)]
    pub fn timer_size(&mut self) -> TimerSizeW<Timer2controlSpec> {
        TimerSizeW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Timer prescale bits."]
    #[inline(always)]
    pub fn timer_pre(&mut self) -> TimerPreW<Timer2controlSpec> {
        TimerPreW::new(self, 2)
    }
    #[doc = "Bit 5 - Interrupt Enable bit."]
    #[inline(always)]
    pub fn interrupt_enable(&mut self) -> InterruptEnableW<Timer2controlSpec> {
        InterruptEnableW::new(self, 5)
    }
    #[doc = "Bit 6 - Timer Mode bit."]
    #[inline(always)]
    pub fn timer_mode(&mut self) -> TimerModeW<Timer2controlSpec> {
        TimerModeW::new(self, 6)
    }
    #[doc = "Bit 7 - Timer Enable Enable bit."]
    #[inline(always)]
    pub fn timer_enable(&mut self) -> TimerEnableW<Timer2controlSpec> {
        TimerEnableW::new(self, 7)
    }
}
#[doc = "Timer 2 Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`timer2control::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`timer2control::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Timer2controlSpec;
impl crate::RegisterSpec for Timer2controlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timer2control::R`](R) reader structure"]
impl crate::Readable for Timer2controlSpec {}
