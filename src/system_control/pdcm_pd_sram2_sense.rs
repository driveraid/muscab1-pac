#[doc = "Register `PDCM_PD_SRAM2_SENSE` reader"]
pub type R = crate::R<PdcmPdSram2SenseSpec>;
#[doc = "Register `PDCM_PD_SRAM2_SENSE` writer"]
pub type W = crate::W<PdcmPdSram2SenseSpec>;
...
#[doc = "Enable sensitivity to PD_SRAM2\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SPdSram2On {
    #[doc = "1: Enable sensitivity to PD_SRAM2"]
    Enable = 1,
    #[doc = "0: Disable sensitivity to PD_SRAM2"]
    Disable = 0,
}
...
#[doc = "Field `S_PD_SRAM2_ON` reader - Enable sensitivity to PD_SRAM2"]
pub type SPdSram2OnR = crate::BitReader<SPdSram2On>;
impl SPdSram2OnR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> SPdSram2On {
        match self.bits {
            true => SPdSram2On::Enable,
            false => SPdSram2On::Disable,
        }
    }
    #[doc = "Enable sensitivity to PD_SRAM2"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == SPdSram2On::Enable
    }
    #[doc = "Disable sensitivity to PD_SRAM2"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == SPdSram2On::Disable
    }
}
#[doc = "Field `S_PD_SRAM2_ON` writer - Enable sensitivity to PD_SRAM2"]
pub type SPdSram2OnW<'a, REG> = crate::BitWriter<'a, REG, SPdSram2On>;
impl<'a, REG> SPdSram2OnW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Enable sensitivity to PD_SRAM2"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut crate::W<REG> {
        self.variant(SPdSram2On::Enable)
    }
    #[doc = "Disable sensitivity to PD_SRAM2"]
    #[inline(always)]
    pub fn disable(self) -> &'a mut crate::W<REG> {
        self.variant(SPdSram2On::Disable)
    }
}
#[doc = "Tied LOW\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
impl R {
    ...
    #[doc = "Bit 5 - Enable sensitivity to PD_SRAM2"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Enable sensitivity to PD_SYS"]
    #[inline(always)]
    pub fn s_pd_sys_on(&mut self) -> SPdSysOnW<PdcmPdSram2SenseSpec> {
        SPdSysOnW::new(self, 0)
    }
    #[doc = "Bit 1 - Enable sensitivity to PD_CPU0CORE"]
    #[inline(always)]
    pub fn s_pd_cpu0core_on(&mut self) -> SPdCpu0coreOnW<PdcmPdSram2SenseSpec> {
        SPdCpu0coreOnW::new(self, 1)
    }
    #[doc = "Bit 2 - Enable sensitivity to PD_CPU1CORE"]
    #[inline(always)]
    pub fn s_pd_cpu1core_on(&mut self) -> SPdCpu1coreOnW<PdcmPdSram2SenseSpec> {
...
#[doc = "Power Control Depedendency Matrix PD_SRAM2 Power Domain Sensitivity\n\nYou can [`read`](crate::Reg::read) this register and get [`pdcm_pd_sram2_sense::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pdcm_pd_sram2_sense::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PdcmPdSram2SenseSpec;
impl crate::RegisterSpec for PdcmPdSram2SenseSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pdcm_pd_sram2_sense::R`](R) reader structure"]
impl crate::Readable for PdcmPdSram2SenseSpec {}
