#[doc = "Register `PDCM_PD_SRAM0_SENSE` reader"]
pub type R = crate::R<PdcmPdSram0SenseSpec>;
#[doc = "Register `PDCM_PD_SRAM0_SENSE` writer"]
pub type W = crate::W<PdcmPdSram0SenseSpec>;
...
#[doc = "Enable sensitivity to PD_SRAM0\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SPdSram0On {
    #[doc = "1: Enable sensitivity to PD_SRAM0"]
    Enable = 1,
    #[doc = "0: Disable sensitivity to PD_SRAM0"]
    Disable = 0,
}
...
#[doc = "Field `S_PD_SRAM0_ON` reader - Enable sensitivity to PD_SRAM0"]
pub type SPdSram0OnR = crate::BitReader<SPdSram0On>;
impl SPdSram0OnR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> SPdSram0On {
        match self.bits {
            true => SPdSram0On::Enable,
            false => SPdSram0On::Disable,
        }
    }
    #[doc = "Enable sensitivity to PD_SRAM0"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == SPdSram0On::Enable
    }
    #[doc = "Disable sensitivity to PD_SRAM0"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == SPdSram0On::Disable
    }
}
#[doc = "Field `S_PD_SRAM0_ON` writer - Enable sensitivity to PD_SRAM0"]
pub type SPdSram0OnW<'a, REG> = crate::BitWriter<'a, REG, SPdSram0On>;
impl<'a, REG> SPdSram0OnW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Enable sensitivity to PD_SRAM0"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut crate::W<REG> {
        self.variant(SPdSram0On::Enable)
    }
    #[doc = "Disable sensitivity to PD_SRAM0"]
    #[inline(always)]
    pub fn disable(self) -> &'a mut crate::W<REG> {
        self.variant(SPdSram0On::Disable)
    }
}
#[doc = "Tied LOW\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SPdSram1On {
    #[doc = "0: Ignores PD_SRAM1 state"]
    Low = 0,
}
...
#[doc = "Field `S_PD_SRAM1_ON` reader - Tied LOW"]
...
impl SPdSram1OnR {
    ...
    pub const fn variant(&self) -> Option<SPdSram1On> {
        match self.bits {
            false => Some(SPdSram1On::Low),
            _ => None,
        }
    }
    #[doc = "Ignores PD_SRAM1 state"]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 3 - Enable sensitivity to PD_SRAM0"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Enable sensitivity to PD_SYS"]
    #[inline(always)]
    pub fn s_pd_sys_on(&mut self) -> SPdSysOnW<PdcmPdSram0SenseSpec> {
        SPdSysOnW::new(self, 0)
    }
    #[doc = "Bit 1 - Enable sensitivity to PD_CPU0CORE"]
    #[inline(always)]
    pub fn s_pd_cpu0core_on(&mut self) -> SPdCpu0coreOnW<PdcmPdSram0SenseSpec> {
        SPdCpu0coreOnW::new(self, 1)
    }
    #[doc = "Bit 2 - Enable sensitivity to PD_CPU1CORE"]
    #[inline(always)]
    pub fn s_pd_cpu1core_on(&mut self) -> SPdCpu1coreOnW<PdcmPdSram0SenseSpec> {
        SPdCpu1coreOnW::new(self, 2)
    }
    #[doc = "Bit 3 - Enable sensitivity to PD_SRAM0"]
    #[inline(always)]
    pub fn s_pd_sram0_on(&mut self) -> SPdSram0OnW<PdcmPdSram0SenseSpec> {
        SPdSram0OnW::new(self, 3)
    }
    #[doc = "Bit 16 - Enable PDEXPIN\\[0\\] signal Sensitivity"]
    #[inline(always)]
    pub fn s_pd_exp0_in(&mut self) -> SPdExp0InW<PdcmPdSram0SenseSpec> {
        SPdExp0InW::new(self, 16)
    }
    #[doc = "Bit 17 - Enable PDEXPIN\\[1\\] signal Sensitivity"]
    #[inline(always)]
    pub fn s_pd_exp1_in(&mut self) -> SPdExp1InW<PdcmPdSram0SenseSpec> {
        SPdExp1InW::new(self, 17)
    }
    #[doc = "Bit 18 - Enable PDEXPIN\\[2\\] signal Sensitivity"]
    #[inline(always)]
    pub fn s_pd_exp2_in(&mut self) -> SPdExp2InW<PdcmPdSram0SenseSpec> {
        SPdExp2InW::new(self, 18)
    }
    #[doc = "Bit 19 - Enable PDEXPIN\\[3\\] signal Sensitivity"]
    #[inline(always)]
    pub fn s_pd_exp3_in(&mut self) -> SPdExp3InW<PdcmPdSram0SenseSpec> {
        SPdExp3InW::new(self, 19)
    }
}
#[doc = "Power Control Depedendency Matrix PD_SRAM0 Power Domain Sensitivity\n\nYou can [`read`](crate::Reg::read) this register and get [`pdcm_pd_sram0_sense::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pdcm_pd_sram0_sense::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PdcmPdSram0SenseSpec;
impl crate::RegisterSpec for PdcmPdSram0SenseSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pdcm_pd_sram0_sense::R`](R) reader structure"]
impl crate::Readable for PdcmPdSram0SenseSpec {}
#[doc = "`write(|w| ..)` method takes [`pdcm_pd_sram0_sense::W`](W) writer structure"]
impl crate::Writable for PdcmPdSram0SenseSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PDCM_PD_SRAM0_SENSE to value 0"]
impl crate::Resettable for PdcmPdSram0SenseSpec {}
